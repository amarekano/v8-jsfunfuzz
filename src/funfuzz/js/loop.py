...
def many_timed_runs(target_time, wtmp_dir, args, collector, ccoverage):
    ...
    while True:
        ...
        js_interesting_args.extend(["--expose-gc", "--allow-natives-syntax"])
...
if __name__ == "__main__":
    many_timed_runs(None, os_ops.make_wtmp_dir(Path(os.getcwd())),sys.argv[1:], create_collector.make_collector(), False)